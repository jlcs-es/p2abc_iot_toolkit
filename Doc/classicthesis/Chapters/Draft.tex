...
As we can see, the three REST calls to the delegation User service involve communication with the smart card. We show in \autoref{fig:IssuanceAPDUs} the APDU Commands for each REST call.

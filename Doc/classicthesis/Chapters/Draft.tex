...
% CMake for managing the cross-compilation, libraries, tests, etc.

\hfil

\paragraph{Core smart card}

% TODO: diagrama con los ficheros de common/core
...
Taking a step forward, we make the core smart card totally independent of any library, only on our interfaces. This means that typical standard C libraries, like \textit{stdlib}, or  

% TODO : diagrama con cada interfaz definida, y otro con cada implementación utilizada (indicar third party src)
...
% TODO : en el workflow se explican cómo se pasa del main al core, etc